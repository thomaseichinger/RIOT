 ...
 * @{
 */
#define AT86RF2XX_STATE_BUSY_RX      (0x01)     /**< currently receiving data */
#define AT86RF2XX_STATE_TX_START     (0x02)     /**< trigger sending data */
#define AT86RF2XX_STATE_RX           (0x06)     /**< wait for incoming data */
