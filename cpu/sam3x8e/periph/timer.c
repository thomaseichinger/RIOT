...
int timer_init(tim_t dev, unsigned int us_per_tick, void (*callback)(int))
{
    ...
    /* configure the frequency of channel 2 to 1us * us_per_tick
     *
     ...
     * is f_ch2 / 2 --> f_ch0/1 = (MCK / 2 / 2 / 1000000) * us_per_tick.
     */
    tim->TC_CHANNEL[2].TC_RC = ((F_CPU / 1000000) / 4) * us_per_tick;
