 ...
 * @{
 */
#define IOD_SEL_UART0_TXD       (0)     /**< UART0 TXD */
#define IOD_SEL_UART1_RTS       (1)     /**< UART1 RTS */
#define IOD_SEL_UART1_TXD       (2)     /**< UART1 TXD */
#define IOD_SEL_SSI0_TXD        (3)     /**< SSI0 TXD */
#define IOD_SEL_SSI0_CLKOUT     (4)     /**< SSI0 CLKOUT */
#define IOD_SEL_SSI0_FSSOUT     (5)     /**< SSI0 FSSOUT */
#define IOD_SEL_SSI0_STXSER_EN  (6)     /**< SSI0 STXSER EN */
#define IOD_SEL_SSI1_TXD        (7)     /**< SSI1 TXD */
#define IOD_SEL_SSI1_CLKOUT     (8)     /**< SSI1 CLKOUT */
#define IOD_SEL_SSI1_FSSOUT     (9)     /**< SSI1 FSSOUT */
#define IOD_SEL_SSI1_STXSER_EN  (10)    /**< SSI1 STXSER EN */
#define IOD_SEL_I2C_CMSSDA      (11)    /**< I2C CMSSDA */
#define IOD_SEL_I2C_CMSSCL      (12)    /**< I2C CMSSCL */
#define IOD_SEL_GPT0_ICP1       (13)    /**< GPT0 ICP1 */
#define IOD_SEL_GPT0_ICP2       (14)    /**< GPT0 ICP2 */
#define IOD_SEL_GPT1_ICP1       (15)    /**< GPT1 ICP1 */
#define IOD_SEL_GPT1_ICP2       (16)    /**< GPT1 ICP2 */
#define IOD_SEL_GPT2_ICP1       (17)    /**< GPT2 ICP1 */
#define IOD_SEL_GPT2_ICP2       (18)    /**< GPT2 ICP2 */
#define IOD_SEL_GPT3_ICP1       (19)    /**< GPT3 ICP1 */
#define IOD_SEL_GPT3_ICP2       (20)    /**< GPT3 ICP2 */
/** @} */
