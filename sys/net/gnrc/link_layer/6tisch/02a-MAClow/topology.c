...
example body for this function which forces a topology is:
   ...
   switch (idmanager_getMyID(ADDR_64B)->addr.addr_64b[7]) {
      case TOPOLOGY_MOTE1:
         if (ieee802514_header->src.addr.addr_64b[7]==TOPOLOGY_MOTE2) {
            returnVal=TRUE;
         } else {
            returnVal=FALSE;
         }
         break;
      case TOPOLOGY_MOTE2:
         if (ieee802514_header->src.addr.addr_64b[7]==TOPOLOGY_MOTE1 ||
             ieee802514_header->src.addr.addr_64b[7]==TOPOLOGY_MOTE3) {
            returnVal=TRUE;
         } else {
            returnVal=FALSE;
         }
...
bool topology_isAcceptablePacket(ieee802154_header_iht* ieee802514_header) {
   ...
   switch (idmanager_getMyID(ADDR_64B)->addr.addr_64b[7]) {
      case 0x4c:
         if (
               ieee802514_header->src.addr.addr_64b[7]==0x00 ||
               ieee802514_header->src.addr.addr_64b[7]==0x60
            ) {
            returnVal=TRUE;
         }
         break;
      case 0x60:
         if (
               ieee802514_header->src.addr.addr_64b[7]==0x4c ||
               ieee802514_header->src.addr.addr_64b[7]==0x97 ||
               ieee802514_header->src.addr.addr_64b[7]==0xc8
            ) {
            returnVal=TRUE;
         }
         break;
      case 0xc8:
         if (
               ieee802514_header->src.addr.addr_64b[7]==0x60 ||
               ieee802514_header->src.addr.addr_64b[7]==0x6f ||
               ieee802514_header->src.addr.addr_64b[7]==0x50
            ) {
            returnVal=TRUE;
         }
         break;
      ...
      case 0x6f:
         if (
               ieee802514_header->src.addr.addr_64b[7]==0x85 ||
               ieee802514_header->src.addr.addr_64b[7]==0x97 ||
               ieee802514_header->src.addr.addr_64b[7]==0xc8
            ) {
            returnVal=TRUE;
      ...
      case 0x85:
         if (
               ieee802514_header->src.addr.addr_64b[7]==0x5c ||
               ieee802514_header->src.addr.addr_64b[7]==0x97 ||
               ieee802514_header->src.addr.addr_64b[7]==0x6f
            ) {
            returnVal=TRUE;
      ...
      case 0x00:
         if (
               ieee802514_header->src.addr.addr_64b[7]==0x4c ||
               ieee802514_header->src.addr.addr_64b[7]==0xa8
            ) {
            returnVal=TRUE;
         }
         break;
