 ...
 *
 * @file
 * @brief       Demonstrating the sending and receiving of IEEE 802.15.4
 *              frames using the basic MAC layer
 *              (i.e.: 'gnrc_802154_basic_mac' module)
 *
...
int basic_send_cmd(int argc, char **argv)
{
    ...
    /* send the packet, via the 'gnrc_802154_basic_mac' module */
