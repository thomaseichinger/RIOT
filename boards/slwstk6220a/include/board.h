 ...
 * @{
 */
/* TODO: comment in once updated UART interface is merged
...
#define SI7021_EN_PIN       GPIO_DEV(PF,8)
/** @} */

/**
 * @brief   GPIO pin for enabling communication through the board controller
 */
#define BC_PIN              GPIO_DEV(PA,12)

/**
 * @brief   User button pin definitions
 * @{
 */
#define PB0_PIN             GPIO_DEV(PE,3)
#define PB1_PIN             GPIO_DEV(PE,2)
/** @} */
 ...
 * @{
 */
#define LED0_PIN            GPIO_DEV(PF,6)
#define LED1_PIN            GPIO_DEV(PF,7)
/** @} */
