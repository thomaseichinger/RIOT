                  ...
                  gpio_cb_t cb, void *arg)
{
    ...
    switch(flank) {
    case GPIO_BOTH:
        lm4f_flank_mode = GPIO_BOTH_EDGES;
        break;
    case GPIO_RISING:
        lm4f_flank_mode = GPIO_RISING_EDGE;
        break;
    case GPIO_FALLING:
        lm4f_flank_mode = GPIO_FALLING_EDGE;
        break;
    }
    ...
    ROM_GPIOIntTypeSet(port_addr, pin_bit, lm4f_flank_mode);
