...
void isr_gptimer0a(void);                                /**< GPTIMER0 Channel A Interrupt Service Routine */
void isr_gptimer0b(void);                                /**< GPTIMER0 Channel B Interrupt Service Routine */
void isr_gptimer1a(void);                                /**< GPTIMER1 Channel A Interrupt Service Routine */
void isr_gptimer1b(void);                                /**< GPTIMER1 Channel B Interrupt Service Routine */
void isr_gptimer2a(void);                                /**< GPTIMER2 Channel A Interrupt Service Routine */
void isr_gptimer2b(void);                                /**< GPTIMER2 Channel B Interrupt Service Routine */
void isr_gptimer3a(void);                                /**< GPTIMER3 Channel A Interrupt Service Routine */
void isr_gptimer3b(void);                                /**< GPTIMER3 Channel B Interrupt Service Routine */
